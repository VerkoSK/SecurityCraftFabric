...
public class CheckPasscodeScreen extends Screen {
	...
	public void extractRenderState(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
		...
		if (isOnCooldown()) {
			...
			extractor.text(font, COOLDOWN_TEXT_1, cooldownText1XPos, height / 2 + 65, 0xFF404040, false);
			extractor.text(font, text, width / 2 - font.width(text) / 2, height / 2 + 75, 0xFF404040, false);
