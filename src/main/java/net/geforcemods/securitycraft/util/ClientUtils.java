...
public class ClientUtils {
	...
	public static void renderModuleInfo(GuiGraphics guiGraphics, Font font, ModuleType module, Component tooltip, boolean hasModule, int x, int y, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, moduleTexture(module), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);

		if (module == ModuleType.REDSTONE)
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, net.minecraft.resources.ResourceLocation.withDefaultNamespace("textures/item/redstone.png"), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);
		else if (module == ModuleType.SPEED)
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, net.minecraft.resources.ResourceLocation.withDefaultNamespace("textures/item/sugar.png"), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);
