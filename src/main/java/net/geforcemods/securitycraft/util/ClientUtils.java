...
public class ClientUtils {
	...
	public static void renderModuleInfo(GuiGraphics guiGraphics, Font font, ModuleType module, Component tooltip, boolean hasModule, int x, int y, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderType::guiTextured, moduleTexture(module), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);

		if (module == ModuleType.REDSTONE)
			guiGraphics.blit(RenderType::guiTextured, net.minecraft.resources.ResourceLocation.withDefaultNamespace("textures/item/redstone.png"), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);
