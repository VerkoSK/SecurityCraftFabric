...
public class ClientUtils {
	...
	public static void renderModuleInfo(GuiGraphics guiGraphics, Font font, ModuleType module, Component tooltip, boolean hasModule, int x, int y, int mouseX, int mouseY) {
		...
		if (module == ModuleType.REDSTONE)
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, net.minecraft.resources.Identifier.withDefaultNamespace("textures/item/redstone.png"), x, y, 0.0F, 0.0F, 16, 16, 16, 16, color);
