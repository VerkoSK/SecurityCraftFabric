...
public class OwnableBlock extends BaseEntityBlock {
	...
	public float getDestroyProgress(BlockState state, Player player, BlockGetter level, BlockPos pos) {
		...
		if (this instanceof IBlockMine)
			return net.geforcemods.securitycraft.util.OwnershipUtils.getDestroyProgress(destroyTimeForOwner, state, player, level, pos, true);

		return net.geforcemods.securitycraft.util.OwnershipUtils.getDestroyProgress(destroyTimeForOwner, state, player, level, pos);
	}
