 ...
 */
public class BaseFullMineBlock extends ExplosiveBlock implements net.geforcemods.securitycraft.api.IBlockMine, net.geforcemods.securitycraft.util.IBlockMine {
	 ...
	 * are neither in creative mode nor the owner. That check needs the player, which the NeoForge-only 5-arg overload
