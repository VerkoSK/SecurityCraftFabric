...
/** Shared right-click behaviour of every mine. 1:1 with the upstream {@code blocks.mines.ExplosiveBlock}. */
public abstract class ExplosiveBlock extends OwnableBlock implements IExplosive {
	...
	public InteractionResult use(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
		...
		if (isActive(level, pos) && isDefusable() && player.getItemInHand(hand).getItem() == SCContent.WIRE_CUTTERS) {
