...
/** The reinforced counterpart of a vanilla CopperBulbBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedCopperBulbBlock extends CopperBulbBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedCopperBulbBlock(BlockBehaviour.Properties properties) {
