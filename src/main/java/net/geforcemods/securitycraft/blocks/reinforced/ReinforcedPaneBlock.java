...
/** The reinforced counterpart of a vanilla IronBarsBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedPaneBlock extends IronBarsBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedPaneBlock(BlockBehaviour.Properties properties) {
