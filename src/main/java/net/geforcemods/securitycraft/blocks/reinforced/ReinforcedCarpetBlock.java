...
/** The reinforced counterpart of a vanilla CarpetBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedCarpetBlock extends CarpetBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedCarpetBlock(BlockBehaviour.Properties properties) {
