...
/** The reinforced counterpart of a vanilla ScaffoldingBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedScaffoldingBlock extends ScaffoldingBlock implements IReinforcedBlock, EntityBlock {
