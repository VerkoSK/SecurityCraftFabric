...
/** The reinforced counterpart of a vanilla WebBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedCobwebBlock extends WebBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedCobwebBlock(BlockBehaviour.Properties properties) {
