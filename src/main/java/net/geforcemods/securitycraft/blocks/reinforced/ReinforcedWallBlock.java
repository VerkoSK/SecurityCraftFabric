...
/** The reinforced counterpart of a vanilla WallBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedWallBlock extends WallBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedWallBlock(BlockBehaviour.Properties properties) {
