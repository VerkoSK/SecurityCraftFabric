...
/** The reinforced counterpart of a vanilla EndRodBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedEndRodBlock extends EndRodBlock implements IReinforcedBlock, EntityBlock {
