...
/** The reinforced counterpart of a vanilla RotatedPillarBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedPillarBlock extends RotatedPillarBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedPillarBlock(BlockBehaviour.Properties properties) {
