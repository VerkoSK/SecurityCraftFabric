...
/** The reinforced counterpart of a vanilla ChainBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedChainBlock extends ChainBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedChainBlock(BlockBehaviour.Properties properties) {
