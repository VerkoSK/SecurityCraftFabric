...
/** The reinforced counterpart of a vanilla LanternBlock. Keeps all of vanilla's behaviour and adds ownership. */
public class ReinforcedLanternBlock extends LanternBlock implements IReinforcedBlock, EntityBlock {
	private final float destroyTimeForOwner;

	public ReinforcedLanternBlock(BlockBehaviour.Properties properties) {
