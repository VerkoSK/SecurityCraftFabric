...
/** 1:1 with the upstream {@code inventory.SingleLensMenu}, plus the client-side constructor this port's menus use. */
public class SingleLensMenu extends AbstractContainerMenu {
	...
	public SingleLensMenu(int windowId, Inventory inventory, FriendlyByteBuf buf) {
	...
	public SingleLensMenu(int windowId, Level level, BlockPos pos, Inventory inventory) {
		super(SCContent.SINGLE_LENS_MENU, windowId);
