...
public abstract class AbstractKeypadFurnaceMenu extends AbstractFurnaceMenu {
	...
	protected AbstractKeypadFurnaceMenu(MenuType<?> menuType, ResourceKey<RecipePropertySet> recipeType, RecipeBookType recipeBookType, int windowId, Inventory inventory, AbstractKeypadFurnaceBlockEntity be) {
