...
public final class SCJadePlugin implements IWailaPlugin, IBlockComponentProvider {
	...
	private static final ResourceLocation SHOW_OWNER = new ResourceLocation(SecurityCraft.MODID, "show_owner");
	private static final ResourceLocation SHOW_MODULES = new ResourceLocation(SecurityCraft.MODID, "show_modules");
	private static final ResourceLocation SHOW_CUSTOM_NAME = new ResourceLocation(SecurityCraft.MODID, "show_custom_name");
