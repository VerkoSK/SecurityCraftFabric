...
/** The Bouncing Betty's mid-air entity, which explodes after its fuse runs out. 1:1 with the upstream {@code entity.BouncingBetty}. */
public class BouncingBetty extends Entity {
	...
	public BouncingBetty(EntityType<BouncingBetty> type, Level level) {
		super(SCContent.BOUNCING_BETTY_ENTITY, level);
	}
