 ...
 * {@link ExtendedScreenHandlerFactory} instead of {@code MenuProvider}, and lens save/load follow the per-slot
 * {@code ValueOutput}/{@code ValueInput} pattern already used by {@code LaserBlockBlockEntity}'s lens container.
 */
public class ClaymoreBlockEntity extends CustomizableBlockEntity implements ITickingBlockEntity, ExtendedScreenHandlerFactory<BlockPos>, ContainerListener, SingleLensContainer {
