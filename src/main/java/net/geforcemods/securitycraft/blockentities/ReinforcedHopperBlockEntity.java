 ...
 */
public class ReinforcedHopperBlockEntity extends HopperBlockEntity implements IOwnable, IModuleInventory, net.fabricmc.fabric.api.blockgetter.v2.RenderDataBlockEntity {
